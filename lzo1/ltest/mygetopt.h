...
extern int mfx_getopt (int argc, char *const *argv, const char *shortopts);
extern int mfx_getopt_long (int argc, char *const *argv, const char *shortopts,
                            const struct mfx_option *longopts, int *longind);

/* Internal only.  Users should not call this directly.  */
extern int mfx_getopt_internal (int argc, char *const *argv,
